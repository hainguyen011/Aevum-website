...
import i2fLabsLogoWhite from '../../assets/I2FLabs-logo.webp';
import i2fLabsLogoDark from '../../assets/I2FLabs-logo-black.webp';

// --- Pure Vector Monochrome Official Brand Logos (Balanced Size, Crisp, Zero Shadows) ---

const LogoUnikorn = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-extrabold tracking-wider">
    {/* Unikorn Vietnam: White logo in Dark Mode, Dark logo in Light Mode */}
    <img 
      src={unikornLogoWhite} 
      alt="Unikorn" 
      loading="lazy" 
      decoding="async" 
      width="28" 
      height="28" 
      className="w-6 h-6 sm:w-7 sm:h-7 object-contain [html[data-theme='light']_&]:hidden" 
    />
    <img 
      src={unikornLogoDark} 
      alt="Unikorn" 
      ...
      width="28" 
      height="28" 
      className="w-6 h-6 sm:w-7 sm:h-7 object-contain hidden [html[data-theme='light']_&]:block" 
    />
    <span className="text-xs sm:text-sm tracking-widest font-mono font-bold">UNIKORN</span>
  </div>
);

const LogoI2FLabs = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-black tracking-wider">
    {/* I2FLabs: White logo in Dark Mode, Black logo in Light Mode */}
    <img 
      src={i2fLabsLogoWhite} 
      alt="I2FLabs" 
      loading="lazy" 
      decoding="async" 
      width="28" 
    ...
    <img 
      ...
      className="w-6 h-6 sm:w-7 sm:h-7 object-contain hidden [html[data-theme='light']_&]:block" 
    />
    <span className="text-xs sm:text-sm tracking-widest font-mono font-bold">I2FLABS</span>
  </div>
);

const LogoAntigravity = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-bold">
    {/* Official Google Antigravity Gaussian Gravity Arch Logomark */}
    <svg className="w-6 h-6 sm:w-7 sm:h-7 shrink-0" viewBox="0 0 180 180" fill="currentColor">
    ...
    <span className="text-xs sm:text-sm tracking-wider font-mono font-bold">ANTIGRAVITY</span>
  </div>
);
...
const LogoClaude = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-semibold">
...
const LogoMCP = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-mono font-bold">
...
const LogoOllama = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-black">
...
const LogoGemini = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-semibold">
    ...
    <span className="text-xs sm:text-sm tracking-wide font-sans font-semibold">Google Gemini</span>
  </div>
);
...
const LogoOpenAI = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-display font-semibold">
    ...
    <span className="text-xs sm:text-sm tracking-wide font-sans font-semibold">OpenAI</span>
  </div>
);
...
const LogoOpenVSX = () => (
  <div className="flex items-center gap-2.5 sm:gap-3 font-mono font-bold">
    ...
    <svg className="w-6 h-6 sm:w-7 sm:h-7 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2l8 4.5v9L12 20l-8-4.5v-9L12 2z" />
      <path d="M12 11l8-4.5" />
      <path d="M12 11v9" />
      <path d="M12 11L4 6.5" />
    </svg>
    <span className="text-xs sm:text-sm tracking-wider font-mono font-bold">OPEN VSX</span>
  </div>
);
